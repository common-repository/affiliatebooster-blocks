function affiliate_generateCSS ( selectors, id, isResponsive = false, responsiveType = "" ) {
	...
	if ( responsiveType == "tablet" ) {
		breakpoint = affiliate_blocks_info.tablet_breakpoint
	} else if ( responsiveType == "mobile" ) {
		breakpoint = affiliate_blocks_info.mobile_breakpoint
	}
...
export default affiliate_generateCSS